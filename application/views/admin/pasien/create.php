<title>SI Klinik - Tambah Pasien</title>
...
<div class="page-wrapper">
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-header bg-dark text-white font-weight-bold text-center">Data Informasi Pasien</div>
                    <form class="form-horizontal" method="post" action="<?php echo base_url(); ?>pasien/save">
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <input type="text" class="form-control" name="no_identitas" maxlength="18" onkeypress='validate(event)' required>
                                    <script>
