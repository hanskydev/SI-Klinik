            ...
            <div class="col-12">
                <div class="card">
                    <form class="form-horizontal" method="post" action="<?php echo base_url(); ?>obat/update">
                        <div class="card-body">
                            <h5 class="card-title">Perbarui Data Informasi Obat</h5>
                            <br>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <input type="text" class="form-control" name="harga_modal" maxlength="20" onkeypress='validate(event)' value="<?php echo $obat->harga_modal; ?>" required>
                                    <script>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <input type="text" class="form-control" name="harga_jual" maxlength="20" onkeypress='validate(event)' value="<?php echo $obat->harga_jual; ?>" required>
                                    <script>
                                        function validate(evt) {
                                            var theEvent = evt || window.event;
                                            // Handle paste
