<title>SI Klinik - Edit Dokter</title>
                    ...
                    <form class="form-horizontal" method="post" action="<?php echo base_url(); ?>dokter/update">
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <input type="text" class="form-control" name="no_telp" maxlength="13" onkeypress='validate(event)' value="<?php echo $dokter->no_telepon; ?>" required>
                                    <script>
