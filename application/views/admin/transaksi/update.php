                            ...
                            <div class="col-md-12">
                                <select class="select2 form-select shadow-none" style="width: 100%; height:36px;" name="item" id="item" required>
                                    ...
                                    <optgroup label="Layanan">
                                        ...
                                        <option item="<?php echo $layanan->nm_layanan;?>" harga="<?php echo $layanan->biaya;?>" modal="<?php echo $layanan->biaya;?>"><?php echo $layanan->nm_layanan; ?></option>
                                        <?php endforeach; ?>
                                    </optgroup>
                                </select>
                            </div>
                        ...
                        <form class="form-horizontal" method="post" action="<?php echo base_url(); ?>transaksi/additem">
                            <div class="form-group row">
                                <div class="col-md-6">
                                    ...
                                    <input type="hidden" class="form-control" name="item_kode" id="item_kode">
                                    <input type="text" class="form-control" name="item_nama" id="item_nama" placeholder="Nama Item" required>
                                </div>
                                <div class="col-md-6">
